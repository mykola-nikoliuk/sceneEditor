export function addTransformControls(THREE) {
  ...
  ( function () {
        ...
        if (_mode === 'translate') {
          ...
          if (scope.space === 'local') {
            ...
            if (scope.axis === 'XYZ') {
              ...
              scale = 1 + ( ( point.y / 50 ) / Math.max(oldScale.x, oldScale.y, oldScale.z) );
    ...
    THREE.TransformControls.TRANSLATE = 'translate';
    THREE.TransformControls.ROTATE = 'rotate';
    THREE.TransformControls.SCALE = 'scale';
